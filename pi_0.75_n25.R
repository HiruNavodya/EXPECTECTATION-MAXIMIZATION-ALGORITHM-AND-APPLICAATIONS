...
details <- setNames(details, c("probability", paste0("Tumour Pair", 1:22)))
...
details[, 24] <- c(rep(2, 7), rep(2, 0), rep(0, nrow(details) - 7))
details[, 25] <- c(rep(2, 7), rep(2, 0), rep(0, nrow(details) - 7))
details[, 26] <- c(rep(2, 7), rep(2, 0), rep(0, nrow(details) - 7))
