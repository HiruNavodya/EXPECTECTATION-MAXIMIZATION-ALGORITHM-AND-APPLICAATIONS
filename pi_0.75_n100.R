...
details <- setNames(details, c("probability", paste0("Tumour Pair", 1:100)))
...
details[, 52] <- c(rep(1, 25), rep(2, 18), rep(0, nrow(details) - 43))
details[, 53] <- c(rep(1, 2), rep(2, 41), rep(0, nrow(details) - 43))
details[, 54] <- c(rep(2, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 55] <- c(rep(2, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 56] <- c(rep(2, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 57] <- c(rep(1, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 58] <- c(rep(1, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 59] <- c(rep(1, 1), rep(2, 42), rep(0, nrow(details) - 43))
details[, 60] <- c(rep(1, 1), rep(2, 42), rep(0, nrow(details) - 43))
details[, 61] <- c(rep(1, 20), rep(2, 23), rep(0, nrow(details) - 43))
details[, 62] <- c(rep(1, 1), rep(2, 42), rep(0, nrow(details) - 43))
details[, 63] <- c(rep(1, 2), rep(2, 41), rep(0, nrow(details) - 43))
details[, 64] <- c(rep(1, 1), rep(2, 42), rep(0, nrow(details) - 43))
details[, 65] <- c(rep(1, 6), rep(2, 37), rep(0, nrow(details) - 43))
details[, 66] <- c(rep(2, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 67] <- c(rep(1, 18), rep(2, 25), rep(0, nrow(details) - 43))
details[, 68] <- c(rep(1, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 69] <- c(rep(2, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 70] <- c(rep(2, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 71] <- c(rep(1, 3), rep(2, 40), rep(0, nrow(details) - 43))
details[, 72] <- c(rep(1, 15), rep(2, 28), rep(0, nrow(details) - 43))
details[, 73] <- c(rep(2, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 74] <- c(rep(1, 7), rep(2, 0), rep(0, nrow(details) - 7))
details[, 75] <- c(rep(2, 7), rep(2, 0), rep(0, nrow(details) - 7))
details[, 76] <- c(rep(1, 7), rep(2, 0), rep(0, nrow(details) - 7))
details[, 77] <- c(rep(1, 18), rep(2, 25), rep(0, nrow(details) - 43))
details[, 78] <- c(rep(2, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 79] <- c(rep(1, 20), rep(2, 23), rep(0, nrow(details) - 43))
details[, 80] <- c(rep(2, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 81] <- c(rep(1, 3), rep(2, 40), rep(0, nrow(details) - 43))
details[, 82] <- c(rep(1, 15), rep(2, 28), rep(0, nrow(details) - 43))
details[, 83] <- c(rep(1, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 84] <- c(rep(1, 7), rep(2, 0), rep(0, nrow(details) - 7))
details[, 85] <- c(rep(2, 7), rep(2, 0), rep(0, nrow(details) - 7))
details[, 86] <- c(rep(2, 7), rep(2, 0), rep(0, nrow(details) - 7))
details[, 87] <- c(rep(1, 18), rep(2, 25), rep(0, nrow(details) - 43))
details[, 88] <- c(rep(1, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 89] <- c(rep(1, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 90] <- c(rep(2, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 91] <- c(rep(1, 3), rep(2, 40), rep(0, nrow(details) - 43))
details[, 92] <- c(rep(1, 15), rep(2, 28), rep(0, nrow(details) - 43))
details[, 93] <- c(rep(2, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 94] <- c(rep(2, 7), rep(2, 0), rep(0, nrow(details) - 7))
details[, 95] <- c(rep(2, 7), rep(2, 0), rep(0, nrow(details) - 7))
details[, 96] <- c(rep(2, 7), rep(2, 0), rep(0, nrow(details) - 7))
details[, 97] <- c(rep(1, 15), rep(2, 28), rep(0, nrow(details) - 43))
details[, 98] <- c(rep(1, 7), rep(2, 36), rep(0, nrow(details) - 43))
details[, 99] <- c(rep(1, 7), rep(2, 0), rep(0, nrow(details) - 7))
details[, 100] <- c(rep(1, 7), rep(2, 0), rep(0, nrow(details) - 7))
details[, 101] <- c(rep(1, 7), rep(2, 0), rep(0, nrow(details) - 7))
